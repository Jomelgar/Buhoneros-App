...
import {DisableButton, ErrorButton, PrimaryButton,SecondaryButton} from "./src/components/ui/button";
import "./global.css";
...
export default function App() {
  ...
  return (
    <View style={styles.container}>
      ...
      <DisableButton text={"Deshabilitado"}/>
      <ErrorButton text="Error"/>
      <SecondaryButton text="Secundario"/>
